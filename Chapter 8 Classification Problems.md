...
言語モデルは、各位置で「語彙の中から次のトークンを選ぶ」巨大な多クラス分類問題として見ることができます。

語彙が50,000個あれば、モデルは50,000個の候補に対してスコアを出し、softmax で確率分布にします。分類問題の softmax と交差エントロピーを理解しておくと、言語モデルの出力がかなり見えやすくなります。

**ミニ演習**

- 第8章の PyTorch コードで、`logits` の値を変えて softmax の出力がどう変わるか確認してみましょう。
