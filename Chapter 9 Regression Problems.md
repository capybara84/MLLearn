...
大規模言語モデルの基本的な事前学習は分類問題として扱うことが多いですが、Transformer 自体は回帰にも使えます。

たとえば、テキストや時系列データを入力して、スコア、価格、需要量、連続的な評価値などを予測するように出力層を設計すれば、Transformer を回帰モデルとして使えます。

**ミニ演習**

- 第9章の PyTorch コードで、訓練データの値を1つ大きく外して、学習結果がどう変わるか見てみましょう。
